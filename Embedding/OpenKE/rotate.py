...
def main():
    ...
    os.makedirs("./checkpoint/rotate", exist_ok=True)
    os.makedirs("./reports", exist_ok=True)

    checkpoint_path = f'./checkpoint/rotate/rotate_{current_time}.ckpt'
    report_path = f'./reports/rotate_cost_report_{current_time}.json'
    ...
    # ===== Save checkpoint =====
    t0 = time.perf_counter()
    rotate.save_checkpoint(checkpoint_path)
    t1 = time.perf_counter()
