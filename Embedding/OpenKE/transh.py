...
def main():
    ...
    os.makedirs("./checkpoint/transh", exist_ok=True)
    os.makedirs("./reports", exist_ok=True)

    checkpoint_path = f'./checkpoint/transh/transh_{current_time}.ckpt'
    report_path = f'./reports/transh_cost_report_{current_time}.json'
    ...
    # ===== Save checkpoint =====
    t0 = time.perf_counter()
    transh.save_checkpoint(checkpoint_path)
    t1 = time.perf_counter()
