...
def main():
    ...
    os.makedirs("./checkpoint/complex", exist_ok=True)
    os.makedirs("./reports", exist_ok=True)

    checkpoint_path = f'./checkpoint/complex/complex_{current_time}.ckpt'
    report_path = f'./reports/complex_cost_report_{current_time}.json'
    ...
    # ===== Save checkpoint =====
    t0 = time.perf_counter()
    complex.save_checkpoint(checkpoint_path)
    t1 = time.perf_counter()
